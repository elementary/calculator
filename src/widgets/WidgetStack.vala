...
namespace Calculus.Widgets {
    public class WidgetStack : Gtk.Stack {
        public StandardWidget standard;
        public ConversionWidget conversion;
        
        public WidgetStack () {
            standard = new StandardWidget ();
            conversion = new ConversionWidget ();
